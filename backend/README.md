...
## Shiprocket shipping weight (Halo Leaf)

Set **Weight (grams)** and optional **Length / Width / Height (mm)** on each product or variant in Medusa Admin (`/app`). Checkout and pincode serviceability use these values to quote Shiprocket rates (actual weight vs volumetric weight, summed per line × quantity, minimum 0.5 kg per cart).
